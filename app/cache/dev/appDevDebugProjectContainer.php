...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\DiaryBundle\\Entity'))), 'DiaryBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DiaryBundle' => 'DiaryBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_932f1af9e1836b1b11829b0c0fc3ff4ca5d3b2e1c23958d407a3d9072245c716');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('lukaszsobieraj@aim.com');
        $a->setPassword('151349La');
        $a->setAuthMode('login');

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.aol.com');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\DiaryBundle/Resources/views'), 'Diary');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('677ac5d2dbca9b7d09e629362bec200fa61b47cb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5765142228acf5.11220225')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DiaryBundle' => 'DiaryBundle\\DiaryBundle',
            ...
            'mailer_host' => 'smtp.aol.com',
            'mailer_user' => 'lukaszsobieraj@aim.com',
            'mailer_password' => '151349La',
            'secret' => '677ac5d2dbca9b7d09e629362bec200fa61b47cb',
            'locale' => 'en',
            ...
            'kernel.secret' => '677ac5d2dbca9b7d09e629362bec200fa61b47cb',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.aol.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'lukaszsobieraj@aim.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '151349La',
